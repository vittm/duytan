	        ...
	        <div class="sqs-block-content">
	            ...
	            <div class="form-wrapper">
	                <div class="form-inner-wrapper">
	                    ...
	                    <form autocomplete="on" action="{{ url('/admin/adding-about') }}" enctype="multipart/form-data"  method="POST" onsubmit="" name="form_addproduct">
	                        ...
	                        <div class="field-list clear">
	                            ...
	                            <fieldset id="name-yui_3_17_2_1_1444669085154_84997" class="form-item fields name required">
	                                ...
	                                <div class="col-md-6 pd0">
	                                    ...
	                                    <input id="post_title" type="text" class="form-control" name="name_about" placeholder="Tên">
	                                </div>
	                        ...
	                        <div id="textarea-yui_3_17_2_1_1444669085154_86192" class="form-item field textarea required">
                                ...
                                <input type="text" class="form-control" name="post_cont"><br>
                            </div>
	                        ...
	                        <div class="form-button-wrapper form-button-wrapper--align-left">
	                            <button type="submit" class="btn btn-info btn-fill pull-right">Thểm about</button>
	                        </div>
