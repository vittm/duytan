...
@foreach($slides as $value)
	                    <form autocomplete="on" action="{{ url('/admin/editing-slide') }}" enctype="multipart/form-data"  method="POST" onsubmit="" name="form_addproduct">
	                        ...
	                        <input type="hidden" name="id_hidden" value="{{ $value->id }}">
	                        	...
	                        	<div class="field-list clear">
			                        ...
			                        <fieldset id="name-yui_3_17_2_1_1444669085154_84997" class="form-item fields name required">
			                            ...
			                            <div class="col-md-6 pd0">
			                                ...
			                                <input id="post_title" type="text" class="form-control" name="title_big" placeholder="Tên bài viết" value="{{ $value->title_big }}">
			                            </div>
			                            <div class="col-md-6">
			                                <label class="caption">
			                                    Tiêu đề nhỏ
			                                </label>
			                                <input id="post_title" type="text" class="form-control" name="title_small" placeholder="Tên bài viết" value="{{ $value->title_small }}">
			                            </div>
			                        </div>
			                        </fieldset>
			                    </div>
	                            ...
	                            <img id="thumbnil" class="edit_img_profile img-reg" src="{{ url('laravel/public/img/slide')}}/{{ $value->img }}" height="100" alt="image" />
